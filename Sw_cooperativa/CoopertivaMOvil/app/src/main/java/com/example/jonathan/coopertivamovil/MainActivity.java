package com.example.jonathan.coopertivamovil;
...
import com.example.jonathan.coopertivamovil.interfaces.IFragments;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            //cuenta
            fragment = new FrgCuente_Cliente();
            fragmentIsSelected=true;
        } else if (id == R.id.nav_gallery) {
            //cliente
            fragment = new FrgCliente();
            fragmentIsSelected=true;
        } else if (id == R.id.nav_slideshow) {
            //transaccion
            fragment = new FrgTransaccion();
            fragmentIsSelected = true;
